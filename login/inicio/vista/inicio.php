...
<head>
  ...
  <style>
    /* Estilos para la caja de credenciales de prueba */
    .test-credentials {
  ...
  <section class="container">
    ...
    <div class="login-form">
      <form action="<?php echo htmlspecialchars(appUrl('/login/inicio/logica/procesar_login.php'), ENT_QUOTES, 'UTF-8'); ?>" method="POST">
        ...
        <!-- 📌 Cuadro de Nota con Credenciales de Prueba -->
        <div class="test-credentials">
          <strong>📌 Credenciales de prueba:</strong>
          <ul>
            <li><strong>Usuario:</strong> <code>admin</code> (o <code>prueba@demo.com</code>)</li>
