        ...
        .then(creditos => {
            ...
            select.onchange = function() {
                ...
                if (sel.dataset.saldo) {
                    ...
                    // Si no hay selección, permitir hasta el saldo total
            ...
            const montoInput = document.getElementById('montoAbono');
            montoInput.value = '';
            // Establecer el máximo inicial al saldo total para abono general
            montoInput.max = totalSaldo.toFixed(2);
...
// Procesar abono usando los IDs correctos del formulario
